...
public class VilainModels extends CivilModels {
    ...
    public VilainModels(int id_civil, int id_adresse, int id_hero, String pouvoir, String point_faible, String danger, String nom, String prenom, AdresseModels adresse, String date_naissance, String date_deces, ArrayList<String> commentaire, String dernier_modif, int incident_declarer, int victime) {
